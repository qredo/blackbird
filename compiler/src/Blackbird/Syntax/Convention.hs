...
--
--------------------------------------------------------------------
module Blackbird.Syntax.Convention
  ( Convention(..)
  , AsConvention(..)
  , strict
  , conv
...
data Convention
  ...
  | N -- strict native value application (for strings)
...
data Conventional a = Conventional a a a a
  deriving (Eq,Ord,Show,Read,Foldable,Traversable,Data,Generic,Generic1)
...
-- instance Eq1 Conventional where eq1 = (==)
...
type instance Index (Conventional _a) = Convention
